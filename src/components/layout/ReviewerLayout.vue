      ...
      <el-aside class="layout-sidebar">
        <el-menu class="sidebar-menu" :default-active="activeMenu" router>
          ...
          <el-sub-menu index="physical_mental">
            ...
            <el-menu-item index="/reviewer/application/physical_mental/achievement">
              成果性评价（上限6分）
            </el-menu-item>
          </el-sub-menu>
          ...
          <el-sub-menu index="art">
            ...
            <el-menu-item index="/reviewer/application/art/basic">
              基础性评价（上限9分）
            </el-menu-item>
            <el-menu-item index="/reviewer/application/art/achievement">
              成果性评价（上限6分）
            </el-menu-item>
          </el-sub-menu>
          ...
          <el-sub-menu index="labor">
            ...
            <el-menu-item index="/reviewer/application/labor/basic">
              基础性评价（上限15分）
            </el-menu-item>
            <el-menu-item index="/reviewer/application/labor/achievement">
              成果性评价（上限10分）
            </el-menu-item>
          </el-sub-menu>
          ...
          <el-sub-menu index="innovation">
            ...
            <el-menu-item index="/reviewer/application/innovation/basic">
              基础素养（上限5分）
            </el-menu-item>
            <el-menu-item index="/reviewer/application/innovation/achievement">
              突破提升（上限40分）
            </el-menu-item>
          </el-sub-menu>
        </el-menu>
