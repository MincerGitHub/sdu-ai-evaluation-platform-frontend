      ...
      <el-aside class="layout-sidebar">
        <el-menu class="sidebar-menu" :default-active="activeMenu" router>
          ...
          <el-sub-menu index="physical_mental">
            ...
            <el-menu-item index="/student/application/physical_mental/achievement">
              成果性评价（上限6分）
            </el-menu-item>
          </el-sub-menu>
          ...
          <el-sub-menu index="art">
            ...
            <el-menu-item index="/student/application/art/achievement">
              成果性评价（上限6分）
            </el-menu-item>
          </el-sub-menu>
          ...
          <el-sub-menu index="labor">
            ...
            <el-menu-item index="/student/application/labor/achievement">
              成果性评价（上限10分）
            </el-menu-item>
          </el-sub-menu>
