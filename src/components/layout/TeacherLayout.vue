    ...
    <el-header class="layout-header">
      ...
      <div class="header-right">
        <el-menu mode="horizontal" class="header-menu" :ellipsis="false">
          <el-menu-item index="archive-entry" @click="go('/teacher/all-applications')">
            归档
          </el-menu-item>
          <el-menu-item index="export-entry" @click="go('/teacher/all-applications')">
            导出
          </el-menu-item>
    ...
    <el-container>
      <el-aside class="layout-sidebar">
        <el-menu
          ...
          :default-openeds="['teacher-application']"
          router
        >
          <el-sub-menu index="teacher-application">
            <template #title>申报</template>
            <el-menu-item index="/teacher/statistics" @click="go('/teacher/statistics')">
              - 申报统计
            </el-menu-item>
            <el-menu-item index="/teacher/all-applications" @click="go('/teacher/all-applications')">
              - 全部申报
            </el-menu-item>
          </el-sub-menu>
